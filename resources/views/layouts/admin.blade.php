...
<div class="row g-0">
    <!-- sidebar -->
    <div class="p-3 col fixed text-white bg-dark" style="height: 819px">
        ...
        <ul class="nav flex-column">
            ...
            <li><a href="{{ route('admin.users.index') }}" class="nav-link text-white">Users Records</a></li>
            <li><a href="{{ route('admin.category.index') }}" class="nav-link text-white">Categories</a></li>
            <li><a href="{{ route('admin.location.index') }}" class="nav-link text-white">Locations</a></li>
